        ...
        <el-form ref="form" :model="formData" :rules="rules" label-width="120px">
            ...
            <el-form-item label="聘用形式" prop="formOfEmployment">
                <el-select v-model="formData.formOfEmployment" style="width:50%" placeholder="请选择">
                    <el-option v-for="item in hireTypeList" :key="item.id" :label="item.value"
...
export default {
    ...
    data() {
        return {
            ...
            loading: false,
            hireTypeList: employeeEnum.hireType
        }
    },
    methods: {
        ...
        btnCancel() {
            ...
            this.$emit('update:showDialog', false) //这里是固定写法: update:showDialog , 因为父向子传递showDialog的时候是添加sync修饰符了
        }
    }
}
</script>
